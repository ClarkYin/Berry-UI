                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            /* removes where the center circle positining is
                            SizedBox(
                  ...
                  child: ScaleTransition(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: BerryAppTheme.nearlyDarkGreen,
                        gradient: LinearGradient(
                            colors: [
                              BerryAppTheme.nearlyDarkGreen,
                              HexColor('#6A88E5'),
                            ],
...
class TabClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    // arcs the middle to create a higher 2 side and a dip for a circle in the middle
    /* path.arcTo(
        Rect.fromLTWH(
